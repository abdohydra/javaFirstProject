...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/userlog.png"))); // NOI18N
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, 0, 500, 440));
        ...
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 10, 40, 30));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 32)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Login");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 420, 41));
        ...
        txtusername.setBackground(new java.awt.Color(97, 147, 246));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 210, 39));

        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_user_20px_1.png"))); // NOI18N
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 140, 20, 30));
        ...
        txtpassword.setBackground(new java.awt.Color(97, 147, 246));
        ...
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 220, 220, 40));
        ...
        jPanel2.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 121, 27));
    ...
    private void disableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_disableMouseClicked
        ...
        disable.setVisible(false); // hides the buton 
        disable.setEnabled(false); // removes the click
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     try {
        ...
        String SQL = "SELECT * FROM saler WHERE login = ? AND password = ?";
        PreparedStatement pstmt = conn.prepareStatement(SQL);
        pstmt.setString(1, username); 
        pstmt.setString(2, password);
        ResultSet resultSet = pstmt.executeQuery();
        if (resultSet.next()) {
            String retrievedUsername = resultSet.getString("login");
            String retrievedPassword = resultSet.getString("password");
            if ("admin".equals(retrievedUsername) && "1234".equals(retrievedPassword)) {
                adminFr admin = new adminFr();
                admin.setVisible(true);
                this.setVisible(false);
            } else {
                Salerframe saler = new Salerframe();
                saler.jLabel10.setText(retrievedUsername);
                saler.setVisible(true);
                this.setVisible(false);
            }
        } else {
